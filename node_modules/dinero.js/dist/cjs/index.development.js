/*! dinero.js 2.0.0-alpha.8 | MIT License | © Sarah Dayan and contributors | https://v2.dinerojs.com */
'use strict';
...
function _toArray$1(arr) {
  return _arrayWithHoles$a(arr) || _iterableToArray$1(arr) || _unsupportedIterableToArray$a(arr) || _nonIterableRest$a();
}
...
function _slicedToArray$8(arr, i) {
  return _arrayWithHoles$9(arr) || _iterableToArrayLimit$8(arr, i) || _unsupportedIterableToArray$9(arr, i) || _nonIterableRest$9();
}
...
function _slicedToArray$7(arr, i) {
  return _arrayWithHoles$8(arr) || _iterableToArrayLimit$7(arr, i) || _unsupportedIterableToArray$8(arr, i) || _nonIterableRest$8();
}
...
function _toArray(arr) {
  return _arrayWithHoles$7(arr) || _iterableToArray(arr) || _unsupportedIterableToArray$7(arr) || _nonIterableRest$7();
}
...
function toFormat$1(calculator) {
  var toUnitFn = toUnit$1(calculator);
...
function toFormat() {
  ...
  var dineroObject = _ref[0],
      transformer = _ref[1];
  var calculator = dineroObject.calculator;
  var formatter = toFormat$1(calculator);
